...
class TestOptions(BaseOptions):
    def initialize(self):
        ...
        self.parser.add_argument("--pic_a_path", type=str, default='./demo_file/photo.jpg', help="Person who provides identity information")
        ...
        self.parser.add_argument("--pic_specific_path", type=str, default='./demo_file/target.jpg', help="The specific person to be swapped")
        self.parser.add_argument("--multisepcific_dir", type=str, default='./demo_file/multispecific', help="Dir for multi specific")
        self.parser.add_argument("--video_path", type=str, default='./demo_file/trumpspeech.mp4', help="path for the video to swap")
        self.parser.add_argument("--temp_path", type=str, default='./temp_results', help="path to save temporarily images")
        self.parser.add_argument("--output_path", type=str, default='./output/trumpspeech_obama.mp4', help="results path")
